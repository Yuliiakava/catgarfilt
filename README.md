...
<body>
    <div id="text">Тут буде ваш текст</div>
    ...
    <script>
        const texts = [
            ...
            "Ми зваримо глінтвейн, закутаємось в пледи і обіцяю, я подивлюсь з тобою і Гаррі Поттера, і Гру Престолів))",
            "А взагалі я за тобою скучаю, та отак, живи тепер з цією думкою, я за тобою скучаю, хоч і не кажу про це так часто.",
            ...
            "АЛЕ я над цим працюю, і між іншим не сама, тому скоро буде зовсім інша я. Давай тільки домовимось, щоб ти не лякався))))))",
